...
function getAllAttrValues(
    ...
    return collections.map(attrValues, function (value) {
        ...
        var processedAttr = {
            ...
            orderable: variationModel.hasOrderableVariants(attr, value)
        };
        ...
        if (isSwatchable(attr.attributeID)) {
            ...
            processedAttr.swatchImage = new ImageModel(value, { types: ['swatch'], quantity: 'single' }).swatch[0];
        }
...
/**
 * @constructor
 * @classdesc Get a list of available attributes that matches provided config with extended attributes as per commerce-sdk
 *
    ...
    collections.forEach(allAttributes, function (attr) {
        ...
        if ((Array.isArray(attrConfig.attributes)
            ...
            result.push({
                ...
                id: attr.ID,
                name: attr.displayName,
                selectedValue: selectedValue && selectedValue.displayValue ?{
                    name: selectedValue.displayValue,
